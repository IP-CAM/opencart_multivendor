<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/opencartdev/seller/');
define('HTTP_SELLER', 'http://localhost/opencartdev/seller/');

define('HTTP_CATALOG', 'http://localhost/opencartdev/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/opencartdev/admin/');
define('HTTPS_SERVER', 'http://localhost/opencartdev/seller/');
define('HTTPS_CATALOG', 'http://localhost/opencartdev/');

// DIR
define('DIR_APPLICATION', '/var/www/html/opencartdev/seller/');
